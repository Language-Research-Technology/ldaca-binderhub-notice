...
<template>
  <main class="page">
    <section class="card" aria-labelledby="notice-title">
      ...
      <div class="url-parts" aria-live="polite">
      ...
      <div class="actions">
        <a :href="mybinderHref" class="action action-primary">
          <span class="action-title">Open on mybinder.org</span>
        ...
        <a :href="nectarHref" class="action action-secondary">
          <span class="action-title">Open on binderhub.rc.nectar.org.au</span>
      ...
      <footer class="partners" aria-label="Partner logos">
        ...
        <img src="/logos/ardc.svg" alt="ARDC" class="partner-logo" loading="lazy" />
      </footer>
    </section>
  </main>
</template>
